...
var _handleCommand = Module['_handleCommand'] = makeInvalidEarlyAccess('_handleCommand');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['handleCommand'] != 'undefined', 'missing Wasm export: handleCommand');
  ...
  _handleCommand = Module['_handleCommand'] = createExportWrapper('handleCommand', 1);
